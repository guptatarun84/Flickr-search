...
let URL_SEARCH = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=675894853ae8ec6c242fa4c077bcf4a0&extras=url_s&format=json&nojsoncallback=1"
...
func getSearchResults(searchText: String, completionHandler: @escaping (ResponseJSON?, Error?) -> ()) {
	let url = "\(URL_SEARCH)&\("text=")\(searchText)"
